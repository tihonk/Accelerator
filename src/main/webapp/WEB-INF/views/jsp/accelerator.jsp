...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/core/css/accelerator.css">
    <title>Mystery</title>
</head>
<nav>
...
<div class="wrapper">
    ...
    <script src="${pageContext.request.contextPath}/resources/core/js/accelerator.js"></script>
</div>
</body>